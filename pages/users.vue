  ...
  <div class="space-y-6 animate-fade-in">
    ...
    <UiModal v-model="editModalOpen" title="Edit User">
      <form @submit.prevent="saveEdit" class="space-y-4">
        ...
        <UiInput v-model="editForm.email" label="Email" type="email" placeholder="Email address" />
        <div class="space-y-1.5">
          <label class="block text-sm font-medium text-[var(--color-text-secondary)]">Role</label>
        ...
        <div class="space-y-1.5">
          <label class="block text-sm font-medium text-[var(--color-text-secondary)]">Status</label>
      ...
      <template #footer>
        <UiButton variant="secondary" @click="editModalOpen = false">Cancel</UiButton>
    ...
    <UiModal v-model="deleteModalOpen" title="Delete User">
      ...
      <template #footer>
        <UiButton variant="secondary" @click="deleteModalOpen = false">Cancel</UiButton>
