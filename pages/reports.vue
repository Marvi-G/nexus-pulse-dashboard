          ...
          >
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1 min-w-0">
                ...
                <p
                  class="text-xs text-[var(--color-text-tertiary)] capitalize mt-0.5"
                >
                  {{ report.type }} • {{ report.generatedBy }}
                </p>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between text-xs">
              ...
              <div
                class="flex items-center gap-3 text-[var(--color-text-tertiary)]"
              >
            ...
            <div class="flex items-center gap-2 pt-1">
              <button
                v-if="report.status === 'completed'"
                class="flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-lg text-sm font-medium text-[var(--color-accent)] bg-[var(--color-accent-light)] hover:bg-[var(--color-accent)]/20 transition-colors"
                @click="handleDownload(report)"
              >
                <svg
                  class="w-4 h-4"
              ...
              <button
                v-if="report.status === 'failed'"
                class="flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-lg text-sm font-medium text-[var(--color-warning)] bg-[var(--color-warning-light)] hover:bg-[var(--color-warning)]/20 transition-colors"
                @click="reportsStore.retryReport(report.id)"
              >
                <svg
                  class="w-4 h-4"
              ...
              <button
                class="flex items-center justify-center gap-2 py-2 px-3 rounded-lg text-sm font-medium text-[var(--color-danger)] bg-[var(--color-danger-light)] hover:bg-[var(--color-danger)]/20 transition-colors"
                @click="reportsStore.deleteReport(report.id)"
              >
                <svg
                  class="w-4 h-4"
